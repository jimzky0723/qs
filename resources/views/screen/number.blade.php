                    ...
                    <div class="panel-body">
                        <div class="mt-1 mb-1 text-center">
                            <button data-modal="modal-senior" class="btn btn-space btn-success btn-big p-4 col-sm-5 md-trigger">
                                <i class="icon fa fa-lg fa-wheelchair"></i> Senior / Pregnant / PWD
                            </button>
                            <button class="btn btn-space btn-info hover btn-big p-4 col-sm-5 md-trigger" data-modal="modal-form"  data-section="pedia" data-equiv="Pedia" data-priority="0" data-number="{{ $sectionNumber['pedia'] }}">
                                <i class="icon fa fa-lg fa-stethoscope"></i>
                                Pedia
                        ...
                        <div class="mt-1 mb-1 text-center">
                            <button data-modal="modal-surgery" class="btn btn-space btn-danger btn-big p-4 col-sm-10 md-trigger"><i class="icon fa fa-lg fa-stethoscope"></i> Animal Bite </button>
                        </div>
                        <hr>
                        <div class="mt-1 mb-1 text-center">
...
@section('modal')
    ...
    <div id="modal-senior" class="modal-container modal-effect-12">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <div class="text-primary"><span class="modal-main-icon fa fa-lg fa-wheelchair"></span></div>
